...
def draw_root_roc_ids_comparison(lowpt,egamma,eta_upper,pt_lower,pt_upper=None):
    ...
    draw_root_roc(tpr,fpr,auc,ele_eff,ele_fr,label='ID, PF standard',color=r.kMagenta+2,style=2)
...
def plot_root_roc_ids_comparison(lowpt,egamma,eta_upper,pt_lower,pt_upper=None):
    ...
    draw_root_roc_ids_comparison(lowpt,egamma,eta_upper,pt_lower)
    ...
    c.SaveAs(f"output/plot_root_roc_ids_comparison.pdf")
    cmsLabels(c,lumiText='2018 (13 TeV)',extraText='Preliminary')
    c.SaveAs(f"output/plot_root_roc_ids_comparison_prelim.pdf")
