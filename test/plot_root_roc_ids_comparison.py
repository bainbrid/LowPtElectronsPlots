...
def plot_root_roc_ids_comparison(lowpt,egamma,eta_upper,pt_lower,pt_upper=None):
    ...
    draw_root_ids_comparison(lowpt,egamma,eta_upper,pt_lower)
    ...
    c.SaveAs(f"plots/roc_root_ids_comparison.pdf")
    cmsLabels(c,lumiText='2018 (13 TeV)',extraText='Preliminary')
    c.SaveAs(f"plots/roc_root_ids_comparison_prelim.pdf")
