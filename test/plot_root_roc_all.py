...
def draw_root_roc_all(lowpt,egamma,eta_upper,pt_lower,pt_upper=None):
...
def plot_root_roc_all(lowpt,egamma,eta_upper,pt_lower,pt_upper=None):
    ...
    draw_root_roc_all(lowpt,egamma,eta_upper,pt_lower)
    ...
    c.SaveAs(f"output/plot_root_roc_all.pdf")
    cmsLabels(c,lumiText='2018 (13 TeV)',extraText='Preliminary')
    c.SaveAs(f"output/plot_root_roc_all_prelim.pdf")
